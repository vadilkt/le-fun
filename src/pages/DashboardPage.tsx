    ...
    <div>
      ...
      <div className="card">
        ...
        <p style={{ fontSize: '0.9rem', color: '#4b5563' }}>
          ...
          <span className="pill">Comptabilité</span> ci‑dessus utilisent pour
          l’instant des données locales de démonstration. Une fois Supabase
          configuré (base PostgreSQL), on lira les vraies commandes, mouvements
          de stock et transactions financières.
        </p>
      </div>
    </div>
  );
